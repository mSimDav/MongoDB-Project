...
<div class="container text-center"> 
 <div class="well">  
       ...
       require_once 'connection.php';
        ...
        $rows = $client->executeQuery("images1.images1", $query);
?>
...
<form method="post" action="search.php">
    Cauta dupa nume:<input type="text" name="title"/>
...
<?php if((isset($val->title))&&(isset($val->about))&&(isset($val->image))&&($val-> title!="")&&($val-> about!="")&& ($val->image!="")):?>    
<tr>
    ...
    <td><?php echo "<a href=\"delete.php?id=".$val->_id."\" onclick=\" return confirm('Are you sure you want to delete this document?')\";> Delete</a>";?> 
</td>
</tr>
    <?php endif;?>
    <?php endforeach;?>
        ...
        <br><br>
<a href="upload.php" class="button">Upload another image</a>
