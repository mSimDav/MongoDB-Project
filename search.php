...
<ul>
<li><?php echo $doc->title;?></li><br>
    <li><?php echo $doc->about;?></li>
    <img src="<?php echo $doc->image;?>" width="100" height="100" class="center">
...
?>
      ...
      <br>
<a href="modifica.php" class="button">Back</a>
 </div></div>
<footer>
        <!-- Contact Us -->
